                        ...
                        <div class='col-md-4 col-xs-6' >
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<h4 class='product-price header-cart-item-info'>$pro_price<del class='product-old-price'>Tk250.00</del></h4>
				...
				echo '
                    ...
                    <div class="product-widget">
												...
												<div class="product-body">
													...
													<h4 class="product-price"><span class="qty">'.$n.'</span>Tk.'.$product_price.'</h4>
												</div>
							...
							<td data-th="Product" >
								<div class="row">
									...
									<div class="col-sm-6">
										...
										<p>If you have been always looking for medical products online store, you are in the right place. Our store is able to provide you with any type of medical goods weather it is the pills or the first aid kit</p>
										</div>
									</div>
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="checkout.php" method="post">
							...
							<input type="hidden" name="business" value="anik81.art@gmail.com>
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/myfiles/public_html/payment_success.php"/>
									...
									<input type="hidden" name="currency_code" value="Taka"/>
