				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=78"><div class="shop">
							...
							<div class="shop-body">
								<h3>Do Not Miss<br>The Best Offer</h3>
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=72"><div class="shop">
							...
							<div class="shop-body">
								<h3>Get You Medicines<br>NOW!!!</h3>
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=79"><div class="shop">
							...
							<div class="shop-body">
								<h3>20% Discount on <br>Selective Items</h3>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="section-title">
							<h3 class="title">Current Products</h3>
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab1">Painkillers</a></li>
									<li><a data-toggle="tab" href="#tab1">Cough</a></li>
									<li><a data-toggle="tab" href="#tab1">Vitamins</a></li>
									<li><a data-toggle="tab" href="#tab1">Equipments</a></li>
								</ul>
							</div>
						</div>
					</div>
                        ...
                        echo "
								...
								<div class='product'>
									...
									<div class='product-body'>
										...
										<h4 class='product-price header-cart-item-info'>$pro_price<del class='product-old-price'>Tk250</del></h4>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="hot-deal">
							...
							<h2 class="text-uppercase">Beximco Pharma this week</h2>
							<p>Selected Medicines Up to 50% OFF</p>
		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="section-title">
							<h3 class="title">Cardinal Care</h3>
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab2"></a></li>
									<li><a data-toggle="tab" href="#tab2">Disinfectants</a></li>
									<li><a data-toggle="tab" href="#tab2">Gloves</a></li>
									<li><a data-toggle="tab" href="#tab2">Masks</a></li>
								</ul>
							</div>
						</div>
					</div>
					...
					$product_query = "SELECT * FROM products,categories WHERE product_cat=cat_id AND product_id BETWEEN 55 AND 61";
                $run_query = mysqli_query($con,$product_query);
                if(mysqli_num_rows($run_query) > 0){
                        ...
                        echo "
								...
								<div class='product'>
									...
									<div class='product-body'>
										<p class='product-category'>$cat_name</p>
										<h3 class='product-name header-cart-item-name'><a href='product.php?p=$pro_id'>$pro_title</a></h3>
										<h4 class='product-price header-cart-item-info'>$pro_price<del class='product-old-price'>Tk500.00</del></h4>
										<div class='product-rating'>
											<i class='fa fa-star'></i>
											<i class='fa fa-star'></i>
											<i class='fa fa-star'></i>
